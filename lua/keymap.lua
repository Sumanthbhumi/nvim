...
map("n", "<F5>", ":w<CR>:!rustc % && ./%:t:r<CR>", { noremap = true, silent = false })
-- Map Ctrl+' to save and run the current file
map("n", "<C-Enter>", ":w<CR>:!rustc % && ./%:t:r<CR>", { noremap = true, silent = false })
...
map("n", "<leader>aa", ":CompetiTest receive problem<CR>", { desc = "add problem" })
map("n", "<leader>ac", ":CompetiTest receive contest<CR>", { desc = "add contest" })
...
map("n", "<leader>ai", ":lua require('harpoon.ui').toggle_quick_menu()<cr>", { desc = "toggle harpoon" })
map("n", "<a-b>", ":lua require('harpoon.ui').nav_next()<cr>", { desc = "harpoon next" })
map("n", "<a-n>", ":lua require('harpoon.ui').nav_prev()<cr>", { desc = "harpoon before" })
